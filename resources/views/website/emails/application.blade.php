		...
		<div id="wrapper" class="div" style="background-color: #fff;">
			...
			<div id="titlebar" class="single titlebar" style="background-color: #f6f6f6; position: relative; padding: 40px; margin-bottom: 50px;">
				<div class="container">
					...
					<div class="sixteen columns">
						<h2 class="h2">Hola {{ $cdata["name"] }}!</h2>
					</div>
				...
				<div class="sixteen columns">
					...
					<div class="post-container">
						<div class="post-content">
							<h3 class="h3">Se ha registrado una nueva postulación!</h3>
							
							<p class="p">Requerimiento: {{ $cdata["job"]}}</p>
							<p class="p">Candidato: {{ $cdata["candidate"]}}</p>
							<p class="p">Notas: {{$cdata["notes"]}}</p>							
						</div>
					</div>
			...
			<div id="footer">
				...
				<div class="container">
					<div class="footer-bottom">
						<div class="sixteen columns">
							<div class="copyrights">©  Copyright 2017 by <a class="a" href="{!!URL::to('/')!!}">IT-Oportunidades</a>. Todos los derechos reservados.</div>
						</div>
					</div>
				</div>
