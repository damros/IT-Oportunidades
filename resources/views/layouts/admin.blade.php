	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="{!!URL::to('/admin/permissions/create')!!}"><i class='fa fa-plus fa-fw'></i> {{trans('labels.Add')}}</a>
							</li>							
							<li>
								<a href="{!!URL::to('/admin/permissions')!!}"><i class='fa fa-list-ol fa-fw'></i> {{trans('labels.Permissions')}}</a>
							</li>							
						</ul>
					</li>	
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="{!!URL::to('/admin/profiles/create')!!}"><i class='fa fa-plus fa-fw'></i> {{trans('labels.Add')}}</a>
							</li>							
							<li>
								<a href="{!!URL::to('/admin/profiles')!!}"><i class='fa fa-list-ol fa-fw'></i> {{trans('labels.Profiles')}}</a>
							</li>							
						</ul>
					</li>	
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="{!!URL::to('/admin/job-types/create')!!}"><i class='fa fa-plus fa-fw'></i> {{trans('labels.Add')}}</a>
							</li>							
							<li>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="{!!URL::to('/admin/users/create')!!}"><i class='fa fa-plus fa-fw'></i> {{trans('labels.Add')}}</a>
							</li>							
							<li>
						...
						<ul class="treeview-menu">						
							<li>
								<a href="{!!URL::to('/admin/companies')!!}"><i class='fa fa-list-ol fa-fw'></i> Empresas</a>
							</li>							
						</ul>
					</li>	
				</ul>
		...
		<footer class="main-footer">
			<div class="pull-right hidden-xs">
				<b>Version</b> 1.2 <b>Fecha</b> 30/06/2017
			</div>
