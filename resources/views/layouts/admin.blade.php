            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-share"></i> <span> Zonas</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li>
                                    <a href="{!!URL::to('/admin/address-zones/create')!!}"><i class='fa fa-plus fa-fw'></i> {{trans('labels.Menu_Add')}}</a>
                                </li>                                
                                <li>
                                    <a href="{!!URL::to('/admin/address-zones')!!}"><i class='fa fa-list-ol fa-fw'></i> {{trans('labels.Menu_List')}}</a>
                                </li>                            
                            </ul>
                        </li>	
                    </ul>
