...
class Candidate extends Model
{
    ...
    protected $fillable = ['slug','name','identification','phone','address','photo','video','profesional_title','resume_content','resume_file','description','user_id','address_zone_id'];
